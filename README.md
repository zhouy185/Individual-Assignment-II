# Individual Case Assignment: Check Point II

Due on **November 12, 2025**, end of day
...
You will use `plotly.express` to create visualizations based on the data and develop insights from them.
...
The notebook outlines the details tasks to be completed.
...
* The customer dataset (to be loaded to Colab)
* `Assignment_2_notebook.ipynb` — your Colab notebook with questions
* `melt_example` for an examole on the `melf` function, which will be useful for creating bar charts.
